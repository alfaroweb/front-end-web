  ...
  return (
    <section className='w-full bg-white'>
      <div className='grid gap-2 pt-16 pb-[34px] max-w-screen-lg mx-auto w-[90%]'>
        ...
        <p className='text-base/relaxed xl:text-lg/relaxed'>
          El Dr. Joaquín Alfaro Micó es licenciado en Medicina y Cirugía por la
        ...
        <p className='text-base/relaxed xl:text-lg/relaxed'>
          Actualmente desarrolla su actividad profesional en el Hospital General
        ...
        <p className='text-base/relaxed xl:text-lg/relaxed'>
          Es socio de la Sociedad Española de Cirugía de la Mano (SECMA), de la
        ...
        <p className='text-base/relaxed xl:text-lg/relaxed'>
          Autor de publicaciones en revistas nacionales e internacionales. Ha
